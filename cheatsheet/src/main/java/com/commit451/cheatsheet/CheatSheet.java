 ...
 * <p>
 * <p>Based on the original action bar implementation in
...
public final class CheatSheet {
    ...
    public static void setup(View view) {
        setup(view, view.getContentDescription());
    }
     ...
     */
    public static void setup(View view, @StringRes final int textResId) {
        setup(view, view.getResources().getString(textResId));
    }
     ...
     */
    public static void showCheatSheet(View view, Toast cheatSheet) {
